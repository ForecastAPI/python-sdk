...
class BatchForecastingApi:
    ...
    @validate_call
    def create_batch_forecast(
        self,
        batch_forecast_request: BatchForecastRequest,
        ...
        :param batch_forecast_request: (required)
        :type batch_forecast_request: BatchForecastRequest
        ...
        _param = self._create_batch_forecast_serialize(
            batch_forecast_request=batch_forecast_request,
    ...
    @validate_call
    def create_batch_forecast_with_http_info(
        self,
        batch_forecast_request: BatchForecastRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BatchForecastAccepted]:
        """Submit a batch of series for forecasting
    ...
    @validate_call
    def create_batch_forecast_without_preload_content(
        self,
        batch_forecast_request: BatchForecastRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_batch_forecast_serialize(
        self,
        ...
        if batch_forecast_request is not None:
            _body_params = batch_forecast_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/batch/forecast',
    ...
    def get_batch_forecast(
        self,
        batch_id: Annotated[StrictStr, Field(description="The id returned by POST /v2/batch/forecast")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param batch_id: The id returned by POST /v2/batch/forecast (required)
        :type batch_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_batch_forecast_serialize(
            batch_id=batch_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BatchForecastStatusResponse",
            '401': "ErrorResponse",
    ...
    @validate_call
    def get_batch_forecast_with_http_info(
        self,
        batch_id: Annotated[StrictStr, Field(description="The id returned by POST /v2/batch/forecast")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BatchForecastStatusResponse]:
        """Poll a batch forecast for status and results
    ...
    @validate_call
    def get_batch_forecast_without_preload_content(
        self,
        batch_id: Annotated[StrictStr, Field(description="The id returned by POST /v2/batch/forecast")],
        _request_timeout: Union[
            None,
    ...
    def _get_batch_forecast_serialize(
        self,
        batch_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/batch/forecast/{batch_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def presign_batch_forecast(
        ...
        _param = self._presign_batch_forecast_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def presign_batch_forecast_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BatchPresignResponse]:
        """Get a presigned URL for a file-based batch upload
    ...
    @validate_call
    def presign_batch_forecast_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _presign_batch_forecast_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/batch/forecast/presign',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
