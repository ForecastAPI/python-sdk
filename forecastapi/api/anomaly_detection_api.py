...
class AnomalyDetectionApi:
    ...
    def detect_anomalies(
        ...
        _param = self._detect_anomalies_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AnomalyDetectionResponse",
            '401': "ErrorResponse",
            '422': "DetectAnomalies422Response",
            '500': "DetectAnomalies500Response",
        }
    ...
    @validate_call
    def detect_anomalies_with_http_info(
        self,
        anomaly_detection_request: AnomalyDetectionRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AnomalyDetectionResponse]:
        """Detect anomalies in time series data
    ...
    @validate_call
    def detect_anomalies_without_preload_content(
        self,
        anomaly_detection_request: AnomalyDetectionRequest,
        _request_timeout: Union[
            None,
    ...
    def _detect_anomalies_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/detect-anomalies',
