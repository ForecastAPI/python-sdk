...
class TrafficForecastingApi:
    ...
    @validate_call
    def create_traffic_forecast(
        self,
        traffic_forecasting_request: TrafficForecastingRequest,
        ...
        :param traffic_forecasting_request: (required)
        :type traffic_forecasting_request: TrafficForecastingRequest
        ...
        _param = self._create_traffic_forecast_serialize(
            traffic_forecasting_request=traffic_forecasting_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TrafficForecastingResponse",
            '400': "CreateInventoryPlan400Response",
            '401': "ErrorResponse",
            '422': "ValidationErrorResponse",
            '500': "CreateTrafficForecast500Response",
        }
    ...
    @validate_call
    def create_traffic_forecast_with_http_info(
        self,
        traffic_forecasting_request: TrafficForecastingRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TrafficForecastingResponse]:
        """Generate traffic forecasting with infrastructure scaling recommendations
    ...
    @validate_call
    def create_traffic_forecast_without_preload_content(
        self,
        traffic_forecasting_request: TrafficForecastingRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_traffic_forecast_serialize(
        self,
        ...
        if traffic_forecasting_request is not None:
            _body_params = traffic_forecasting_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/traffic-forecasting',
