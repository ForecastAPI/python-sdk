...
class AnomalyDetectionResponseMetaTiming(BaseModel):
    """
    AnomalyDetectionResponseMetaTiming
    """ # noqa: E501
    validation: Optional[Union[StrictFloat, StrictInt]] = None
    detection: Optional[Union[StrictFloat, StrictInt]] = None
    total: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["validation", "detection", "total"]
