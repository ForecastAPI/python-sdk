...
class InventoryPlanningResponseMeta(BaseModel):
    """
    InventoryPlanningResponseMeta
    """ # noqa: E501
    timing: Optional[InventoryPlanningResponseMetaTiming] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timing": InventoryPlanningResponseMetaTiming.from_dict(obj["timing"]) if obj.get("timing") is not None else None,
