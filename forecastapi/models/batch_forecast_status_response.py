...
class BatchForecastStatusResponse(BaseModel):
    ...
    batch_parts: Optional[StrictInt] = Field(default=None, description="Number of parts the batch was split into for processing")
    results: Optional[BatchForecastStatusResponseResults] = None
    parts: Optional[List[BatchForecastStatusResponsePartsInner]] = Field(default=None, description="Per-part progress metadata (the forecasts themselves live under results.data)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": BatchForecastStatusResponseResults.from_dict(obj["results"]) if obj.get("results") is not None else None,
            "parts": [BatchForecastStatusResponsePartsInner.from_dict(_item) for _item in obj["parts"]] if obj.get("parts") is not None else None,
