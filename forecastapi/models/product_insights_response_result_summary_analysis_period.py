...
class ProductInsightsResponseResultSummaryAnalysisPeriod(BaseModel):
    """
    ProductInsightsResponseResultSummaryAnalysisPeriod
    """ # noqa: E501
    start_date: Optional[StrictStr] = None
    end_date: Optional[StrictStr] = None
    total_days: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["start_date", "end_date", "total_days"]
