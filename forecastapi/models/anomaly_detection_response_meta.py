...
class AnomalyDetectionResponseMeta(BaseModel):
    """
    AnomalyDetectionResponseMeta
    """ # noqa: E501
    timing: Optional[AnomalyDetectionResponseMetaTiming] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timing": AnomalyDetectionResponseMetaTiming.from_dict(obj["timing"]) if obj.get("timing") is not None else None
        })
        return _obj
