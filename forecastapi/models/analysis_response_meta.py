...
class AnalysisResponseMeta(BaseModel):
    """
    AnalysisResponseMeta
    """ # noqa: E501
    timing: Optional[AnalysisResponseMetaTiming] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timing": AnalysisResponseMetaTiming.from_dict(obj["timing"]) if obj.get("timing") is not None else None
        })
        return _obj
