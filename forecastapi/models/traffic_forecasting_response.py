...
class TrafficForecastingResponse(BaseModel):
    """
    TrafficForecastingResponse
    """ # noqa: E501
    result: Optional[TrafficForecastingResponseResult] = None
    meta: Optional[TrafficForecastingResponseMeta] = None
    __properties: ClassVar[List[str]] = ["result", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": TrafficForecastingResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
            "meta": TrafficForecastingResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
