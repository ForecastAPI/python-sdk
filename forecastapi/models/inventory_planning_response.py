...
class InventoryPlanningResponse(BaseModel):
    """
    InventoryPlanningResponse
    """ # noqa: E501
    result: Optional[InventoryPlanningResponseResult] = None
    meta: Optional[InventoryPlanningResponseMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": InventoryPlanningResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
            "meta": InventoryPlanningResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
