...
class TrafficForecastingRequestDataInner(BaseModel):
    """
    TrafficForecastingRequestDataInner
    """ # noqa: E501
    var_date: StrictStr = Field(description="Date/time of the data point (supports both date and datetime formats)", alias="date")
    value: Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]] = Field(description="Traffic volume for the period")
