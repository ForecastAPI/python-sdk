...
class ProductInsightsResponseResultComparisonDevelopments(BaseModel):
    """
    ...
    unchanged_count: Optional[StrictInt] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["new", "changed", "resolved", "unchanged_count", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unchanged_count": obj.get("unchanged_count"),
