...
class ProductInsightsResponseMetaDataQuality(BaseModel):
    """
    ProductInsightsResponseMetaDataQuality
    """ # noqa: E501
    total_data_points: Optional[StrictInt] = None
    datasets_provided: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["total_data_points", "datasets_provided"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total_data_points": obj.get("total_data_points"),
            "datasets_provided": obj.get("datasets_provided")
        })
        return _obj
