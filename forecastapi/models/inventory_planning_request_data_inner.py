...
class InventoryPlanningRequestDataInner(BaseModel):
    """
    InventoryPlanningRequestDataInner
    """ # noqa: E501
    var_date: date = Field(description="Date of the data point (YYYY-MM-DD format)", alias="date")
    value: Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]] = Field(description="Demand/sales quantity for the date")
