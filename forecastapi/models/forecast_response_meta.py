...
class ForecastResponseMeta(BaseModel):
    """
    ForecastResponseMeta
    """ # noqa: E501
    selection_metric: Optional[StrictStr] = Field(default=None, description="The back-testing metric that actually chose the winning model")
    timing: Optional[ForecastResponseMetaTiming] = None
    __properties: ClassVar[List[str]] = ["selection_metric", "timing"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timing": ForecastResponseMetaTiming.from_dict(obj["timing"]) if obj.get("timing") is not None else None
        })
        return _obj
