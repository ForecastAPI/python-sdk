...
class ProductInsightsResponse(BaseModel):
    ...
    """ # noqa: E501
    result: Optional[ProductInsightsResponseResult] = None
    meta: Optional[ProductInsightsResponseMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": ProductInsightsResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
            "meta": ProductInsightsResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
