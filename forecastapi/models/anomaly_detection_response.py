...
class AnomalyDetectionResponse(BaseModel):
    ...
    """ # noqa: E501
    result: Optional[AnomalyDetectionResponseResult] = None
    meta: Optional[AnomalyDetectionResponseMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": AnomalyDetectionResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
            "meta": AnomalyDetectionResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
