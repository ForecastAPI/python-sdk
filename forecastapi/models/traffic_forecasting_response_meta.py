...
class TrafficForecastingResponseMeta(BaseModel):
    """
    TrafficForecastingResponseMeta
    """ # noqa: E501
    timing: Optional[TrafficForecastingResponseMetaTiming] = None
    auto_selection: Optional[AutoSelection] = None
    __properties: ClassVar[List[str]] = ["timing", "auto_selection"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of auto_selection
        if self.auto_selection:
            _dict['auto_selection'] = self.auto_selection.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timing": TrafficForecastingResponseMetaTiming.from_dict(obj["timing"]) if obj.get("timing") is not None else None,
            "auto_selection": AutoSelection.from_dict(obj["auto_selection"]) if obj.get("auto_selection") is not None else None
        })
        return _obj
