...
class AnalysisResponse(BaseModel):
    ...
    AnalysisResponse
    """ # noqa: E501
    result: Optional[AnalysisResponseResult] = None
    meta: Optional[AnalysisResponseMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": AnalysisResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
            "meta": AnalysisResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
